...
;              
CREATE USER IF NOT EXISTS "SA" SALT 'aba1f0470f1451f9' HASH 'd24c2d5e74c6803e8511c2b9a00a47d9b4dad9dddd9eb9e88559d67af42dd8eb' ADMIN;          
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME", "TEAM_ID") VALUES(1, NULL, 'web', TRUE, TRUE, '$2a$10$PMVkA3EGR.iAemeyLUXTjOWvrOYmk4qGEK/IGDG2dcd10/U44cgSK', NULL, 'admin', 1);    
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME", "TEAM_ID") VALUES(2, '5f62a394-2b7c-40b8-9b32-8917206047d4', 'web', TRUE, FALSE, '$2a$10$LOKGoccy2fQ4gc4r2yiEG.Prm24a0W/AC3dwGPcQY1MaTceF9TVpS', NULL, 'STIRLING-PDF-BACKEND-API-USER', 2);         
